    ...
    <ContentBase >
        <ContentBaseSecondary>
            ...
            <div style="color: #999999; font-size:14px;">
                作者：
                <router-link style="text-decoration: none; color:#337ab7"
                :to=data.user_path>
            ...
            <div align="right" v-if="data.user_id === $store.state.user.id">
                ...
                &nbsp;
                <button @click="delete_dialog = true" type="button" class="btn btn-outline-danger">
            ...
            <div v-html="data.content" style="border-radius: 2px; width:70%;margin: auto;background-color: #F2F3F5;"></div>
        </ContentBaseSecondary>
        <br>
        <ContentBaseSecondary>
            <CommentBase :latest_id="latest_id" :comment="comment" :user_info="user_info" @submitComment="submitComment" @removeComment="removeComment"></CommentBase>
        </ContentBaseSecondary>
    </ContentBase>
</template>
